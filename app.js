...
async function getLyrics(artist, songTitle) {
    ...
    songCollection.innerHTML = `
        <h4 class ="flow-text center purple-text" style="font-weight: bold;">${songTitle}</h4><h5 class ="flow-text center grey-text">${artist}</h5>
        <div>
            <p class="flow-text center">${lyrics}</p>
        </div>
    `
